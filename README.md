...
|                                     | Coordinated median [Goel et al.](http://www.its.caltech.edu/~whanncar/papers/median.pdf) |
...
Clone the repository. The main framework runtime is packaged in a [whl file](federated-learning-lib/federated_learning_lib-1-py3-none-any.whl). 
